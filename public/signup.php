...
<body class="body">
    <section class="logo">
        <img src="../assets/images/logo/logoBPT.png" alt="" id="logoP">
    </section>

    <section class="vh-100 gradient-custom cadre">
  <div class="container py-5 h-100">
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration bordure" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Inscrivez-vous ici :</h3>
            <form>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 d-flex align-items-center">
                  ...
                  <div class="form-outline datepicker w-100">
                    ...
                    <label for="birthdayDate" class="form-label">Votre date de naissance</label>
                  </div>
